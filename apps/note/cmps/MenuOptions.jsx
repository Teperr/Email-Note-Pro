...
export function MenuOptions() {
    return <section className="Menu-options">
        <div className="list-container">
            ...
            <Link to="/note/archive"><span><i className="fa-regular fa-folder-open"></i><button>Archives</button></span></Link>
            <Link to="/note/garbage"><span><i className="fa-regular fa-trash-can"></i><button>Garbage</button></span></Link>
        </div>
    </section>
}
